...
Наполняет содержимым и отрисовывает карточку товара на главной странице. Является наследником класса Component. 

Поля класса: 
сохранены такие элементы разметки, которые содержат название, изображение, категорию товара, его стоимость, выбран товар или нет, а также объект, позволяющий применять разную стилизацию для разных категорий товаров. 
...
Позволяет отрисовать карточку товара с подробным описанием товара. Является наследником класса Card. 
...
Наполняет содержимым и отрисовывает карточку товара в корзине. Является наследником класса Component. 

Поля класса: 
сохранены такие элементы разметки, которые содержат порядковый номер, название товара, его стоимость и кнопку удаления из корзины. 

Конструктор класса: 
принимает в параметры родительский контейнер (тип HTMLElement), может также принимать объект actions, который можно использовать при навешивании обработчиков событий. 

Содержит сеттеры для установления значения полей карточки.
